                    ...
                    dbc.Col(
                        [
                            html.Div(
                                [
                                    html.H1(
                                        "🤖 Trading Bot Simulator", className="mb-2"
                                    ),
                                    html.P(
                                        "Advanced Reinforcement Learning Trading Environment",
...
def create_metric_card(title, value, icon, color="primary"):
    ...
    return html.Div(
        [html.H3([html.I(className=f"fas fa-{icon} me-2"), title]), html.H2(value)],
            ...
            dbc.Row(
                [
                    ...
                    dbc.Col(
                        create_metric_card(
                            "Portfolio Value",
                            f"${global_state['current_portfolio'].get_portfolio_value(0):,.2f}"
                            if global_state["current_portfolio"]
                            else "$0.00",
                            "wallet",
                        ),
                        width=3,
            ...
            dbc.Tabs(
                [
                    dbc.Tab(
                        ...
                        label=[html.I(className="fas fa-rocket me-2"), "Fetch Data"],
                        tab_id="fetch-tab",
                    ),
                    dbc.Tab(
                        [
                            ...
                            dbc.Row(
                                [
                                    dbc.Col(
                                        [
                                            html.H4(
                                                "🗑️ Cache Management", className="mb-3"
                                            ),
                                            dbc.Button(
                                                [
                                                    html.I(
...
def create_training_layout():
    ...
    return dbc.Container(
        [
            dbc.Row([dbc.Col([html.H2("🎯 Model Training", className="mb-4")])]),
            dbc.Tabs(
                [
                    dbc.Tab(
                        [
...
def create_evaluation_layout():
    ...
    return dbc.Container(
        [
            dbc.Row([dbc.Col([html.H2("📋 Model Evaluation", className="mb-4")])]),
            dbc.Row(
                [
                    dbc.Col(
                        [
            ...
            dbc.Row([dbc.Col([html.Div(id="evaluation-results")])]),
        ],
        fluid=True,
        className="content-area",
    )
...
def create_live_trading_layout():
    ...
    return dbc.Container(
        [
            dbc.Row(
                [dbc.Col([html.H2("💰 Live Trading Simulation", className="mb-4")])]
            ),
            dbc.Row(
                [
                    dbc.Col(
            ...
            dbc.Row([dbc.Col([html.Div(id="live-trading-status")])]),
            dbc.Row(
                [
                    dbc.Col(
                        [
...
def create_settings_layout():
    ...
    return dbc.Container(
        [
            dbc.Row([dbc.Col([html.H2("⚙️ Settings", className="mb-4")])]),
            dbc.Tabs(
                [
                    dbc.Tab(
                        [
                            dbc.Row(
                                [
                                    dbc.Col(
                                        [
                                            html.H4(
                                                "🔧 General Settings", className="mb-3"
                                            ),
                                            dbc.Form(
                                                [
                                                    dbc.Row(
                            ...
                            dbc.Row(
                                [
                                    dbc.Col(
                                        [
                                            html.H4(
                                                "📊 Advanced Settings", className="mb-3"
                                            ),
                                            dbc.Form(
                                                [
                                                    dbc.Row(
...
app.layout = dbc.Container(
    [
        ...
        dcc.Interval(
            id="interval-component", interval=5000, n_intervals=0  # 5 seconds
        ),
    ],
    fluid=True,
)
...
@app.callback(
    [Output("yfinance-options", "style"), Output("csv-options", "style")],
...
# Fetch data callback
@app.callback(
    [Output("data-preview", "children"), Output("data-store", "data")],
...
def fetch_data(
    n_clicks, source, ticker, interval, start_date, end_date, cache_data, csv_contents
):
    """Fetch market data."""
    if n_clicks is None:
        return "", None
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Table.from_dataframe(
                            data.head(10), striped=True, bordered=True, hover=True
                        ),
                    ],
                    width=6,
                ),
...
# Training callback
@app.callback(
    [Output("training-status", "children"), Output("models-store", "data")],
...
def start_training(
    n_clicks, algo, total_timesteps, seed, window_size, fee_bps, reward_scheme
):
    ...
    try:
        ...
        return (
            dbc.Alert("Training completed successfully!", color="success"),
...
# Chart callbacks
@app.callback(Output("price-chart", "figure"), [Input("data-store", "data")])
...
@app.callback(
    Output("portfolio-chart", "figure"), [Input("interval-component", "n_intervals")]
)
